...
public class hashset {
    public static void main(String[] args) {
        ...
        //HashSet 값 삭제
        HashSet<Integer> setD = new HashSet<Integer>(Arrays.asList(1,2,3));//HashSet생성
        setD.remove(1);//값 1 제거
        setD.clear();//모든 값 제거
        ...
        //HashSet 크기 구하기
        HashSet<Integer> setH = new HashSet<Integer>(Arrays.asList(1,2,3));//HashSet생성
        System.out.println(setH.size());//set 크기 : 3
        //HashSet의 크기를 구하려면 size() 메소드를 사용하면 됩니다.

        //HashSet 값 출력
        HashSet<Integer> setPUT = new HashSet<Integer>(Arrays.asList(1,2,3));//HashSet생성

        System.out.println(setPUT); //전체출력 [1,2,3]
        ...
        //HashSet 값 검색
        HashSet<Integer> setS = new HashSet<Integer>(Arrays.asList(1,2,3));//HashSet생성
        System.out.println(setS.contains(1)); //set내부에 값 1이 있는지 check : true
